...
private:
	...
	Plane plane{ wnd.Gfx(), "../src/Casli/Image/wall_diffuse.jpg", 1, glm::vec3(0.51, 0, 0), glm::vec4(50.0, 1, 0, 0) };
	Plane mipPlane{ wnd.Gfx(), "../src/Casli/Image/wall_diffuse.jpg", 10, glm::vec3(-0.51, 0, 0), glm::vec4(50.0, 1, 0, 0), FILTER::FILTER_LINEAR_MIP_POINT };
